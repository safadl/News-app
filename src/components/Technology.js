...
class Technology extends React.Component{
    ...
    makeRemoteRequest = _.debounce(() => {
        ...
        getArticlesH('technology', this.state.country).then(data=>{
...
<ActivityIndicator style={{margin:Dimensions.get('window').height/4}} animating={this.state.isLoading} color='#14b1ab' size='large'/>
        </View>
    ) : 
    (
      // <View style={{backgroundColor:MyTheme.colors.background}}>
        ...
        return(
            ...
            </Picker><Content style={{backgroundColor:this.props.color? "#000000" : 'white' }}>{view}</Content>
