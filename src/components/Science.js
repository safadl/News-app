...
class Science extends React.Component{
    ...
    makeRemoteRequest = _.debounce(() => {
        ...
        getArticlesH('science', this.state.country).then(data=>{
...
<ActivityIndicator style={{margin:Dimensions.get('window').height/4}} animating={this.state.isLoading} color='#ff9a76' size='large'/>
        </View>
    ) : 
    (
