...
class Health extends React.Component{
    ...
    makeRemoteRequest = _.debounce(() => {
        ...
        getArticlesH('Health', this.state.country).then(data=>{
...
<ActivityIndicator style={{margin:Dimensions.get('window').height/4}} animating={this.state.isLoading} color='#5fdde5' size='large'/>
        </View>
    ) : 
    (
